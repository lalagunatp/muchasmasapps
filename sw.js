...
const CACHE = 'tp-fuerzaventas-v32';
...
self.addEventListener('fetch', function(e){
  ...
  // empleados.csv: hoy no se usa (la lista se lee directo de la hoja), pero si
  // algun dia se vuelve a activar, se busca primero en la red para que las
  // altas y bajas lleguen el mismo dia, con la copia guardada de respaldo.
